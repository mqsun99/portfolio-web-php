...
- Click on the databases tab and create a database naming “db_freelance” and then click on the import tab
- Click on browse file and select “db_freelance.sql” file which is inside the “db” folder
- Open a browser and go to URL “http://localhost/freelance”
